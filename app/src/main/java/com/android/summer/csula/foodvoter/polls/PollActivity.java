...
public class PollActivity extends AppCompatActivity implements OnPollListener {
    ...
    protected void onDestroy() {
        ...
        if (savePoll) {
            ...
            // The user canceled the poll, remove the temporally poll from firebase.
    ...
    private void initializeFirebasePollReference() {
        ...
        // Save default poll to firebase
        pollRef.setValue(poll);
        Log.d(TAG, "temp poll saved to firebase: " + poll.toString());

        // When the poll values change (ie, in the Invite Tab), update our class Poll object
    ...
    private void swapFragment(TabLayout.Tab tab) {
        ...
        // Save the poll onto firebase database before switching to another tab so we
        // can continue updating it on the other tab.
        pollRef.setValue(poll);
